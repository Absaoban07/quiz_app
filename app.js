let sociologicalQuizData = [
    ...
    {
      question: "Which sociological perspective focuses on how individuals interact and form symbolic meanings?",
      options: [
        " Functionalism",
        " Conflict Theory",
    ...
    },
    {
      ...
      correctAnswer: " The alteration of human behavior when individuals are aware they are being observed."
    },
  ];
...
let result = 0;
  ...
  selectElement.forEach((select, index) => {
    select.addEventListener('change',(event) =>{
      ...
      document.querySelectorAll('.selected')[index].innerHTML =`Selected answer:  ${selectValue }`;
      document.querySelectorAll('.answer')[index].innerHTML = `Correct answer: ${sociologicalQuizData[index].correctAnswer}`;
